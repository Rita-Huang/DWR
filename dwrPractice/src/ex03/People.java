...
/**
 * A container for 2 sets of people. The smaller is designed for viewing all at
 * the same time, and is viewable and editable via {@link #getSmallCrowd()},
 * {@link #setPerson(Person)} and {@link #deletePerson(String)}. The larger is
 * accessible using the {@link StoreProvider} registered under 'largeCrowd', and
 * searchable using {@link #getMatchingFromLargeCrowd(String)}
 * 
...
public class People
{
    ...
    public People()
    {
        ...
        MapStoreProvider<Person> provider = new MapStoreProvider<Person>(
                createCrowd(1000), Person.class);
    ...
    public static void main(String[] args)
    {
        ...
        // MapStoreProvider<Person> provider = new
        // MapStoreProvider<Person>(reply, Person.class);
        
//        People p1=new People();
//        System.out.println(p1.getSmallCrowd());
    }
...
//        System.out.println(smallCrowd.keySet());
//        System.out.println(smallCrowd.values());
    ...
    /**
     * Both crowds are created in the same way. 自動產生Person物件及其屬性值的方法
     * 
     * @param count
     *            需要產生的資料筆數
     * @return String:Person的ID<br>
     *         Person:Person物件
     */
